...
\newcommand{\ponerQRcaption}[2]{
    \begin{tikzpicture}[remember picture, overlay]
        \node[anchor=south east, inner sep=15pt, opacity=#2, align=center] at (current page.south east) {
            \includegraphics[width=#1]{QR.png} \\
            \vspace{1mm}
            {\tiny \textbf{DIAPOSITIVAS}}
        };
    \end{tikzpicture}
}
...

{
    ...
    \setbeamertemplate{background}{\ponerQRcaption{2.2cm}{1.0}}
    \begin{frame}[plain]
        \titlepage
    \end{frame}
}
