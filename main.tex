...
\begin{frame}
  ...
  \vspace{5mm}
  \textbf{Pregunta:}
  ¿Existe una base $\mathcal{B} = \{ v_{1}, v_{2} \}$ de $\mathbb{R}^{2}$ tal que las imágenes de $v_{1}$ y $v_{2}$ sean particularmente fáciles de describir?
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[scale=.4]{empty-figure.png}
  \end{center}
  \pause

  $\quad \rightsquigarrow$ No es particularmente fácil de describir.
  \pause
  Por ejemplo, no es fácil calcular $g(1,0)$.
...
\begin{frame}
  ...
  $\quad \rightsquigarrow$ En este caso sí es fácil calcular $g(1,1)$!
...
\begin{frame}
  ...
  $\quad \rightsquigarrow$ En este caso también es fácil calcular $g(2,1)$:
